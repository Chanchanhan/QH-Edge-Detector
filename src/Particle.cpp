...
// static void update_(Particle *p, Traker &tracker, cv::Mat frame, cv::Mat prevFrame,GLRenderer &renderer,int frame_id,  bool useAR)
// {
// 	register float *rt = p->rt;
// 	register float *trt = p->trt;
// 	register float *ort = p->ort;
...
// 	float e2 = 1E12;
// 	int ret = tracker.toTrack(trt,frame,frame_id,renderer,ort, e2);
// 
